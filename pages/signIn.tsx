...
const SignIn: VFC = () => {
  ...
  return (
    <div className="w-screen h-screen bg-warmGray-100 overflow-y-auto">
      <div className="w-full bg-green-800 h-12"></div>
      <h1 className="w-full font-bold text-green-800 text-2xl text-center mt-16">
        ログイン
      </h1>
      <div
        className="shadow-md flex items-center bg-white w-56 h-10 cursor-pointer rounded-md mx-auto mt-8"
        onClick={login}
      >
        <svg
          className="w-5 ml-4"
        ...
        <span className="ml-4 font-bold text-sm text-warmGray-500">
          Googleでログインする
        </span>
      </div>
    </div>
