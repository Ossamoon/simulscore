        ...
        <div className="max-w-3xl mx-auto px-8 my-16 text-warmGray-800">
          ...
          <ul className="pt-16 space-y-16">
            ...
            <li className="space-y-4">
              ...
              <ul className="list-decimal pl-4 space-y-4">
                ...
                <li>
                  ...
                  <ul className="pt-4 space-y-4 pl-8">
                    <li>
                      (1)
            ...
            <li className="space-y-4">
              ...
              <p>
                運営者による利用者の個人情報の取扱いについては、別途
                <Link href="/privacy">
                  <a className="text-blue-700">プライバシーポリシー</a>
                </Link>
                の定めによるものとし、利用者はこのプライバシーポリシーに従って運営者が利用者の個人情報を取扱うことについて同意するものとします。
              </p>
            </li>
            <li className="space-y-4">
            ...
            <li className="space-y-4">
              ...
              <p>
                本サービスは、広告および関連商品のAmazon.co.jpへのリンクを掲載することがあります。
              </p>
              <p>
                なお、本サービスは、Amazon.co.jpを宣伝しリンクすることによってサイトが紹介料を獲得できる手段を提供することを目的に設定されたアフィリエイトプログラムである、Amazonアソシエイト・プログラムの参加者です。
              </p>
            </li>
            <li className="space-y-4">
              <h2 className="font-bold text-xl">第12条（免責事項）</h2>
              <ul className="list-decimal pl-4 space-y-4">
                <li>
                ...
                <li>
                  運営者は、本サービスにおいてアソシエイトリンクの掲載がある商品が、利用者の期待する有用性・完全性を有することについて、明示または黙示を問わず何ら保証するものではなく、これらに関する瑕疵を除去する義務を利用者に対して負いません。
                </li>
                <li>
            ...
            <li className="space-y-4">
              <h2 className="font-bold text-xl">第13条（分離可能性）</h2>
              <p>
